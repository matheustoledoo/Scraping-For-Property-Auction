...
chrome_driver_path = chromedriver_autoinstaller.install()
  # Atualize para o caminho do seu chromedriver
...
while True:
    ...
    # Supondo que cada imóvel esteja contido em uma div
    imovel_cards = driver.find_elements(By.XPATH, '//div[contains(@class, "col-xs-12 col-sm-6 col-md-4 col-lg-3 dg-leiloes-item-col ")]')
    ...
    for index, card in enumerate(imovel_cards, start=1):
        try:
            ...
            status_element = card.find_element(By.XPATH, './/div[contains(@class, "BoxBtLoteLabel")]')
        ...
        try:
            ...
            link_element = card.find_element(By.CLASS_NAME, 'dg-leiloes-nome-leilao')
