...
for i, link in enumerate(all_links, start=1):
    ...
    try:
        ...
        try:
            titulo_leilao = driver.find_element(By.XPATH, '//*[@id="lotes"]/div[1]/div/div[5]/div[6]/p').text
            print(f"  [OK] Título: {titulo_leilao}")
        except:
            titulo_leilao = None
    ...
    try:
        ...
        try:
            numero_processo = driver.find_element(By.CLASS_NAME, "status-item num-processo").text
