...
BASE_URL = (
    "https://www.leilaobrasil.com.br/buscador?categoria=2&page={page}"
)
        ...
        for card in cards:
            try:
                status = card.find_element(
                    By.XPATH, './/strong[contains(@class, "strong-status status-1")]'
                ).text.strip()
            except Exception:
                status = ""
            try:
...
def process_links(driver: webdriver.Chrome, link_status: List[Tuple[str, str]]) -> List[dict]:
    ...
    for idx, (link, status) in enumerate(link_status, start=1):
        ...
        data.update({
            ...
            "valor_imovel": get_text('/html/body/section[4]/div/div[2]/div/div[2]/div/div[1]/ul[2]/li[3]/div[2]/strong') or get_text('/html/body/section[4]/div/div[2]/div/div[2]/div/div[1]/ul[2]/li[2]/div[2]/strong') or get_text('/html/body/section[4]/div/div[2]/div/div[2]/div/div[1]/ul[2]/li[1]/div[2]/strong') or get_text('//div[contains(@class, "data-right")]'),
